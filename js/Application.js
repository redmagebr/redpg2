...
var PicaPensil = (function (_super) {
    ...
    function PicaPensil() {
        var _this = _super.call(this) || this;
        _this.id = "Pensil";
        _this.currentArt = null;
        PicaCanvasPen.registerPen(_this.id, _this);
        return _this;
    }
    ...
    PicaPensil.prototype.beginDrawing = function (point) {
...
var PicaToolShare = (function (_super) {
    ...
    function PicaToolShare() {
        ...
        _this.a.classList.add("leftPicaToolButton");
        _this.a.classList.add("icons-picaShare");
        UI.Language.addLanguageTitle(_this.a, "_PICASHARE_");
        UI.Language.markLanguage(_this.a);
        return _this;
    }
